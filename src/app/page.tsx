...
export default function Home() {
  ...
  return (
    <main className="min-h-screen px-8 py-0 pb-12 flex-1 flex-col items-center">
      <header className="w-full py-4 justify-between items-center">
      ...
      <div className="max-w-4xl">
        <div className="grid bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
          ...
          <div className="flex justify-center items-centerp-4">
            <w3m-button />
          </div>
        </div>
        <br></br>
